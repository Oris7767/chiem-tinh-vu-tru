...
export const numberMeanings: NumberMeaning[] = [
  ...
  },
  {
    ...
    planet: "Rahu (Bắc Đẩu)",
    description: "Số 4 thể hiện cho một người hoặc một vật phổ biến. Người số 4 không mang lại may mắn như người ta mong đợi. Họ sẽ có những nỗi sợ vô cớ, bệnh tật và đối kháng. Họ có thể thông thái và hiểu biết, nhưng vẫn sẽ chỉ làm việc như những người dưới quyền người khác. Những người có số 13 gặp nhiều sự kiện đau buồn bất ngờ, đàn ông có kinh nghiệm cay đắng và gặp nhiều khó khăn vì phụ nữ. Mặc dù những người này quản lý để tiến bộ trong cuộc sống vật chất, nhưng họ vẫn sẽ dẫn đầu cuộc sống đầy đấu tranh.",
    strengths: ["Ổn định", "Đáng tin cậy", "Chăm chỉ", "Thực tế", "Có tổ chức"],
    challenges: ["Lo lắng không cần thiết", "Đối kháng", "Phụ thuộc", "Thiếu tự tin"],
    career: "Phù hợp làm việc dưới quyền người khác, trong lĩnh vực đòi hỏi sự đáng tin cậy và kỷ luật.",
    relationships: "Trong các mối quan hệ, người số 4 có thể gặp khó khăn, đặc biệt là nam giới có thể có kinh nghiệm cay đắng với phụ nữ.",
    finance: 30,
    romance: 20,
    education: 40,
    health: 30,
