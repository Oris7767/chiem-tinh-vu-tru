...
interface CalculatorFormProps {
  onCalculate: (name: string, day: string, month: string, year: string) => void;
  isCalculating: boolean;
}

const CalculatorForm = ({ onCalculate, isCalculating }: CalculatorFormProps) => {
  ...
  const handleSubmit = () => {
    ...
    onCalculate(name, day, month, year);
  };
